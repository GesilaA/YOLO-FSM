...
class Tester(object):
    ...
    def test(self):
        if self.__visiual:
            ...
            for v in imgs:
                ...
                if bboxes_prd.shape[0] != 0:
                    ...
                    path = os.path.join('./', 'out/{}'.format(v))
        ...
        if self.__eval:
            ...
            with torch.no_grad():
                APs, F1s, scaled_APs = Evaluator(self.__model, metric_root=None).APs_voc(self.__multi_scale_test, self.__flip_test)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='../weight/select_best.pt', help='weight file path')
