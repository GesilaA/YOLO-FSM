...
from ..layers.conv_module import Convolutional, Copy_Convolutional
from ..layers.blocks_module import Residual_block, FeatureUp_block
...
class Darknet53(nn.Module):
    ...
    def __init__(self):
        ...
        # self.__conv_5_2_3 = Convolutional(filters_in=256, filters_out=256, kernel_size=3, stride=1, pad=1, norm='bn',
        #                                   activate='leaky')
